...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-05-2024 a las 22:27:48
...
--
-- Estructura de tabla para la tabla `tbcommentaire`
--

CREATE TABLE `tbcommentaire` (
  `idCommentaire` smallint(6) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbcommentaire`
--

INSERT INTO `tbcommentaire` (`idCommentaire`, `dateCreation`, `commentaire`, `idUtilisateur`) VALUES
(1, '2024-04-28', 'Prueba1', 2),
(2, '2024-04-29', 'Prueba 2', 2),
(3, '2024-04-29', 'Prueba 3', 2),
(4, '2024-04-29', 'Prueba 4', NULL),
(5, '2024-04-29', 'Prueba 5', NULL),
(6, '2024-04-29', 'Prueba 6', NULL),
(7, '2024-04-29', 'Prueba 7', NULL),
(8, '2024-04-29', 'Prueba 8', NULL),
(9, '2024-04-29', 'Prueba 9', NULL),
(10, '2024-04-29', 'Prueba 10', NULL),
(11, '2024-04-29', 'Prueba 11', 2);
...
--
-- Estructura de tabla para la tabla `tbfilmcommentaire`
--

CREATE TABLE `tbfilmcommentaire` (
  `idFilm` smallint(6) NOT NULL,
  `idCommentaire` smallint(6) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbfilmcommentaire`
--

INSERT INTO `tbfilmcommentaire` (`idFilm`, `idCommentaire`) VALUES
(1, 7),
(1, 8),
(1, 9),
(1, 10),
...
--
-- Indices de la tabla `tbcommentaire`
--
ALTER TABLE `tbcommentaire`
...
--
-- Indices de la tabla `tbfilmcommentaire`
--
ALTER TABLE `tbfilmcommentaire`
  ADD PRIMARY KEY (`idFilm`,`idCommentaire`),
...
--
-- AUTO_INCREMENT de la tabla `tbcommentaire`
--
ALTER TABLE `tbcommentaire`
  MODIFY `idCommentaire` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- Filtros para la tabla `tbcommentaire`
--
ALTER TABLE `tbcommentaire`
  ADD CONSTRAINT `tbcommentaire_ibfk_1` FOREIGN KEY (`idUtilisateur`) REFERENCES `tbutilisateur` (`noUtilisateur`);
...
--
-- Filtros para la tabla `tbfilmcommentaire`
--
ALTER TABLE `tbfilmcommentaire`
  ADD CONSTRAINT `tbfilmcommentaire_ibfk_1` FOREIGN KEY (`idCommentaire`) REFERENCES `tbcommentaire` (`idCommentaire`),
  ADD CONSTRAINT `tbfilmcommentaire_ibfk_2` FOREIGN KEY (`idFilm`) REFERENCES `tbfilm` (`noFilm`);
